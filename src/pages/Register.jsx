...
const handleSubmit = async (event) => {
    ...
    Swal.fire({ 
        title: "¡Éxito!", 
        text: "Cuenta creada. Inicia sesión para continuar.", 
        icon: "success", 
        confirmButtonColor: brandPurple 
    })
    navigate("/login")
    ...
    Swal.fire({
        ...
        text: error.message || "Hubo un problema al crear la cuenta. Intenta con otro correo.",
        confirmButtonColor: brandPurple
    })
    ...
    <Container className="d-flex justify-content-center align-items-center flex-grow-1 py-5">
        ...
        <Card.Body className="p-4">
            ...
            <Form.Group className="mb-3">
                ...
                <Form.Control type="password" placeholder="Mínimo 8 caracteres" value={password} onChange={(e) => setPassword(e.target.value)} style={{ border: "2px solid black" }} minLength={8} required />
            </Form.Group>
            ...
            <div className="text-center">
                <Link to="/login" className="small fw-bold" style={{ color: brandPurple }}>Volver al login</Link>
            </div>
            </Form>
        </Card.Body>
        </Card>
